...
func (h *podFeaturesAdmitHandler) Admit(ctx context.Context, attrs *PodAdmitAttributes) PodAdmitResult {
...
func (c *declaredFeaturesAdmitHandler) Admit(ctx context.Context, attrs *PodAdmitAttributes) PodAdmitResult {
	pod := attrs.Pod
