...
var (
	...
	kubeletConfigurationNonPathFieldPaths = sets.New[string](
		...
		"SystemCgroups",
		"SystemPartition.CPUSet",
		"SystemPartition.MemoryLimit.Format",
		"SystemPartition.MemoryLimit.d.Dec.scale",
		"SystemPartition.MemoryLimit.d.Dec.unscaled.abs[*]",
		"SystemPartition.MemoryLimit.d.Dec.unscaled.neg",
		"SystemPartition.MemoryLimit.i.scale",
		"SystemPartition.MemoryLimit.i.value",
		"SystemPartition.MemoryLimit.s",
		"SystemPartition.Namespaces[*]",
