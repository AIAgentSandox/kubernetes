...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*configv1beta1.SystemPartitionConfiguration)(nil), (*config.SystemPartitionConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_SystemPartitionConfiguration_To_config_SystemPartitionConfiguration(a.(*configv1beta1.SystemPartitionConfiguration), b.(*config.SystemPartitionConfiguration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.SystemPartitionConfiguration)(nil), (*configv1beta1.SystemPartitionConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_SystemPartitionConfiguration_To_v1beta1_SystemPartitionConfiguration(a.(*config.SystemPartitionConfiguration), b.(*configv1beta1.SystemPartitionConfiguration), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_KubeletConfiguration_To_config_KubeletConfiguration(in *configv1beta1.KubeletConfiguration, out *config.KubeletConfiguration, s conversion.Scope) error {
	...
	if err := Convert_v1beta1_SystemPartitionConfiguration_To_config_SystemPartitionConfiguration(&in.SystemPartition, &out.SystemPartition, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_config_KubeletConfiguration_To_v1beta1_KubeletConfiguration(in *config.KubeletConfiguration, out *configv1beta1.KubeletConfiguration, s conversion.Scope) error {
	...
	if err := Convert_config_SystemPartitionConfiguration_To_v1beta1_SystemPartitionConfiguration(&in.SystemPartition, &out.SystemPartition, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1beta1_SystemPartitionConfiguration_To_config_SystemPartitionConfiguration(in *configv1beta1.SystemPartitionConfiguration, out *config.SystemPartitionConfiguration, s conversion.Scope) error {
	*out = *(*config.SystemPartitionConfiguration)(unsafe.Pointer(in))
	return nil
}

// Convert_v1beta1_SystemPartitionConfiguration_To_config_SystemPartitionConfiguration is an autogenerated conversion function.
func Convert_v1beta1_SystemPartitionConfiguration_To_config_SystemPartitionConfiguration(in *configv1beta1.SystemPartitionConfiguration, out *config.SystemPartitionConfiguration, s conversion.Scope) error {
	return autoConvert_v1beta1_SystemPartitionConfiguration_To_config_SystemPartitionConfiguration(in, out, s)
}

func autoConvert_config_SystemPartitionConfiguration_To_v1beta1_SystemPartitionConfiguration(in *config.SystemPartitionConfiguration, out *configv1beta1.SystemPartitionConfiguration, s conversion.Scope) error {
	*out = *(*configv1beta1.SystemPartitionConfiguration)(unsafe.Pointer(in))
	return nil
}

// Convert_config_SystemPartitionConfiguration_To_v1beta1_SystemPartitionConfiguration is an autogenerated conversion function.
func Convert_config_SystemPartitionConfiguration_To_v1beta1_SystemPartitionConfiguration(in *config.SystemPartitionConfiguration, out *configv1beta1.SystemPartitionConfiguration, s conversion.Scope) error {
	return autoConvert_config_SystemPartitionConfiguration_To_v1beta1_SystemPartitionConfiguration(in, out, s)
}
